...
test('feature: produces section with computed dimensions and node list', () => {
  ...
  const blockH = C.BANNER_HEIGHT + C.FLOW_BANNER_TO_TAG_GAP + C.TAG_HEIGHT + C.TAG_TO_IPHONE_GAP + C.IPHONE_HEIGHT + C.IPHONE_TO_JUSTIFICATION_GAP + C.JUSTIFICATION_HEIGHT
